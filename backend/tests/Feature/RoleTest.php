...
class RoleTest extends TestCase
{
    ...
    public function test_index_filters_by_keywords(): void
    {
        ...
        $response = $this->getJson('/api/v1/system/roles?keywords=特殊角色');
    ...
    public function test_show_returns_role_detail(): void
    {
        ...
        $response = $this->getJson("/api/v1/system/roles/{$role->id}");
    ...
    public function test_update_modifies_role(): void
    {
        ...
        $response = $this->putJson("/api/v1/system/roles/{$role->id}", [
            'name' => '修改后名称',
        ]);
    ...
    public function test_destroy_deletes_role(): void
    {
        ...
        $response = $this->deleteJson("/api/v1/system/roles/{$role->id}");
    ...
    public function test_get_role_menus_returns_menu_ids(): void
    {
        ...
        $response = $this->getJson("/api/v1/system/roles/{$role->id}/menus");
