...
class UserTest extends TestCase
{
    ...
    public function test_index_filters_by_keywords(): void
    {
        ...
        $response = $this->getJson('/api/v1/system/users?keywords=unique_kw');
    ...
    public function test_index_filters_by_status(): void
    {
        ...
        $response = $this->getJson('/api/v1/system/users?status=0');
    ...
    public function test_show_returns_user_detail(): void
    {
        ...
        $response = $this->getJson("/api/v1/system/users/{$user->id}");
    ...
    {
        $response = $this->getJson('/api/v1/system/users/99999');
    ...
    public function test_update_status_disables_user(): void
    {
        ...
        $response = $this->patchJson("/api/v1/system/users/{$user->id}/status", ['status' => 0]);
    ...
    public function test_update_status_validates_value(): void
    {
        ...
        $response = $this->patchJson("/api/v1/system/users/{$user->id}/status", ['status' => 5]);
    ...
    public function test_reset_password_changes_password(): void
    {
        ...
        $response = $this->postJson("/api/v1/system/users/{$user->id}/reset-password");
