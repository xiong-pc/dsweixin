...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // UserLog Management
        $userLog = Menu::create([
            'parent_id' => $system->id, 'name' => '操作日志管理', 'type' => 2,
            'path' => 'user_log', 'component' => 'system/user_log/index', 'icon' => 'Document',
            'sort' => 10, 'visible' => 1, 'permission' => '',
        ]);
        Menu::create(['parent_id' => $userLog->id, 'name' => '日志新增', 'type' => 3, 'permission' => 'sys:user_log:add',    'sort' => 1]);
        Menu::create(['parent_id' => $userLog->id, 'name' => '日志编辑', 'type' => 3, 'permission' => 'sys:user_log:edit',   'sort' => 2]);
        Menu::create(['parent_id' => $userLog->id, 'name' => '日志删除', 'type' => 3, 'permission' => 'sys:user_log:delete', 'sort' => 3]);
